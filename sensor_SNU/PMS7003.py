...
class PMS7003(object):
    ...
    def print_serial(self, buffer):
        ...
        print ("============================================================================")
        f = open("PM_2022_1123.csv", "a")
        timestamp = time.strftime('%y-%m-%d %H:%M:%S')
        f.write(timestamp + ','
                +str(data[self.DUST_PM1_0_CF1])
                +','+str(data[self.DUST_PM2_5_CF1])
                +','+str(data[self.DUST_PM10_0_CF1])
                +','+str(data[self.DUST_PM1_0_ATM])
                +','+str(data[self.DUST_PM2_5_ATM])
                +','+str(data[self.DUST_PM10_0_ATM])
                +','+str(data[self.DUST_AIR_0_3])
                +','+str(data[self.DUST_AIR_0_5])
                +','+str(data[self.DUST_AIR_1_0])
                +','+str(data[self.DUST_AIR_2_5])
                +','+str(data[self.DUST_AIR_5_0])
                +','+str(data[self.DUST_AIR_10_0])
                +'\n')
        f.close()
        time.sleep(1)
