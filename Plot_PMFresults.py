...
df_contri = pd.read_csv('210607recal_ConstrainedErrorEstimationSummary_v1_contribution.csv').dropna()
...
for i, s in enumerate(Sources_name):
    ...
    ax1.text(19,0.4, s, size=20, ha='center')
...
for i, s in enumerate(Sources_name):
    ...
    ax1.text(1.0,0.85,
             ...
             size=14, ha='right', transform=ax1.transAxes)
